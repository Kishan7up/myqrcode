...
/// A web implementation of the MyqrscanPlatform of the Myqrscan plugin.
class MyqrscanWeb extends MyqrscanPlatform {
  /// Constructs a MyqrscanWeb
  MyqrscanWeb(){
  ...
  static void registerWith(Registrar registrar) {
    MyqrscanPlatform.instance = MyqrscanWeb();
  }
